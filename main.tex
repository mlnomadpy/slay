...
\icmlauthor{Jose Miguel Luna}{columbia}
\icmlauthor{Taha Bouhsine}{azetta}
\icmlauthor{Krzysztof Choromanski}{deepmind}
\end{icmlauthorlist}

\icmlaffiliation{columbia}{Columbia University}
\icmlaffiliation{azetta}{Azetta.ai}
\icmlaffiliation{deepmind}{Google DeepMind}

\icmlcorrespondingauthor{Taha Bouhsine}{taha@azetta.ai}
...
\addplot+[green!60!black, mark=diamond*] coordinates {
(128,0.67) (256,0.68) (512,0.99) (1024,1.60)
(2048,2.75) (4096,5.04) (8192,9.77) (16384,19.49)
(32768,38.95) (65536,77.82) (131072,155.84)
};
\addlegendentry{RFF}
...
\addplot+[red, very thick, mark=star] coordinates {
...
\end{axis}
\end{tikzpicture}
\caption{Latency versus sequence length. Quadratic attention mechanisms scale poorly and fail beyond 16K tokens, while all linear methods—including SLAY—exhibit linear scaling up to 128K tokens.}
...
\addplot+[green!60!black, mark=diamond*] coordinates {
(128,27.8) (256,45.5) (512,80.7) (1024,152.1)
...
\end{axis}
\end{tikzpicture}
\caption{Peak GPU memory usage versus sequence length. Exact quadratic methods exhibit quadratic memory growth and fail beyond 16K tokens, while SLAY maintains a low and strictly linear memory footprint.}
...
\addplot+[green!60!black, mark=diamond*] coordinates {
(128,190123) (256,377653) (512,518545) (1024,640919)
(2048,743937) (4096,813471) (8192,838907) (16384,840637)
(32768,841283) (65536,842144) (131072,841091)
};
\addlegendentry{RFF}
...
\end{axis}
\end{tikzpicture}
\caption{Throughput versus sequence length. Linear attention methods—including SLAY—maintain high throughput at long context lengths, while quadratic methods rapidly degrade and become infeasible.}
\label{fig:throughput-scaling}
\end{figure}

\subsection{Attention Approximation Errors}
...
\centering
\small
\caption{Synthetic task performance (Long‑Range). Accuracy (mean $\pm$ std over 3 seeds).}
\label{tab:task-longrange}
\begin{tabular}{lccc}
\toprule
...
\centering
\small
\caption{Synthetic task performance (Patterns). Accuracy (mean $\pm$ std over 3 seeds).}
\label{tab:task-patterns}
\begin{tabular}{lccc}
\toprule
